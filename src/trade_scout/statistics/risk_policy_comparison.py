"""Reproducible risk-policy comparison over one frozen event population.

The risk layer owns event-level stop/exit evaluation. This statistics-layer module owns
cross-policy aggregation and comparison so lower risk code never depends on downstream
...
class RiskPolicyComparisonRun:
    ...
    harness_definition_version: str = "risk-policy-comparison-harness-v0.2"
