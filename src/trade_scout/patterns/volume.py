...
def trailing_volume_ratio(
    ...
    *,
    ...
    The signal session is excluded from the baseline so the value matches the exploratory
    consolidation-breakout detector's existing point-in-time volume semantics.
    """
