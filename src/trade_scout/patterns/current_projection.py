...
def project_latest_consolidation_state(
    ...
    The function intentionally delegates pattern formation and event generation to the canonical
    lifecycle pipeline. It performs no independent breakout detection and inspects no future bar.
    """
